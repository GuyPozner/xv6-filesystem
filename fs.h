...
*/
#define NDIRECT 11 // The number of direct blocks
#define NINDIRECT (BSIZE / sizeof(uint)) // The number of block addresses stored in a singly-indirect block
#define NDOUBLE_INDIRECT (NINDIRECT*NINDIRECT) // The number of block addresses stored in a doubly-indirect block
#define MAXFILE (NDIRECT + NINDIRECT + NDOUBLE_INDIRECT) // The maximum number of files in a block
